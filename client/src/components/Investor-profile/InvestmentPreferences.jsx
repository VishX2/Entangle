  ...
  return (
    <div className="bg-white rounded-2xl p-6 border border-slate-100">
      ...
      <div>
        ...
        <SuccessCard
          title="TechFlow AI"
          description="Led seed round, company now valued at $50M"
          growth="+340%"
        />

        <SuccessCard
          title="GreenGrid Energy"
          description="Series A investor, successful exit in 2023"
          growth="+280%"
        />
      </div>
    </div>
...
function SuccessCard({ title, description, growth }) {
  return (
    <div className="bg-orange-50 rounded-xl p-4 flex items-center justify-between mb-3 last:mb-0">
      <div>
...
function BagIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
      <rect x="3" y="7" width="18" height="14" rx="2" stroke="#64748b" strokeWidth="2" />
      <path d="M8 7V5a4 4 0 0 1 8 0v2" stroke="#64748b" strokeWidth="2" />
    </svg>
  );
}
