...
import defaultProfile from "../../../assets/startup-profile/startup1.jpg";
import defaultCover from "../../../assets/startup-profile/cover.jpg";

export default function EditStartupProfileHeader() {
  const [profileImage, setProfileImage] = useState(defaultProfile);
  const [coverImage, setCoverImage] = useState(defaultCover);
  const [bio, setBio] = useState(
    "Serial entrepreneur turned angel startup with 15+ years in tech. Passionate about backing visionary founders building transformative companies in fintech, AI, and climate tech."
  );
