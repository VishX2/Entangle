      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <h1 className="text-5xl font-bold mb-6">
            ...
            <span className="text-purple-600">Startup</span>{' '}
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12">
          <h2 className="text-3xl font-bold text-slate-800 mb-2">Startup Registration</h2>
          <p className="text-slate-600 mb-8">Fill in your startup details to get started</p>
